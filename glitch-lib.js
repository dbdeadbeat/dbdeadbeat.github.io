...
(function ($) {
  ...
  var _glitch = function (canvas, amount) {
    var // cache the width and height of the canvas locally
      x,
      y,
      w = canvas.width,
      h = canvas.height,
    ...
    for (i = 0; i < _len; i++) {
      ...
      tempCtx.drawImage(canvas, 0, y, chunkWidth, chunkHeight, x, y, chunkWidth, chunkHeight);

      // draw the rest
      tempCtx.drawImage(canvas, chunkWidth, y, x, chunkHeight, 0, y, x, chunkHeight);
    }
